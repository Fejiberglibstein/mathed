...
where $\Gamma (z)$ is the Gamma function\footnote{See https://en.wikipedia.org/wiki/Gamma\_function}, or $(z-1)!$.
Taking this as well as the other patterns of $G_n(x)$ into account, $G_n(x)$ is defined as
$$G_n(x) = \sum_{t=0}^{n}\frac{\Gamma \left \lfloor \frac{n+i}{2}+1 \right \rfloor}{\Gamma[t+1]\cdot \Gamma \left \lfloor \frac{n-i}{2}+1 \right \rfloor}b^{t}x^{\frac{1-(-1)^{n+t}}{2}}$$
